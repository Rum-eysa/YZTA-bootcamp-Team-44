...
PROMPT_TEMPLATES: dict[str, str] = {
    ...
    "cv_content_filter": (
        ...
        "CV'ye basılacağını seç; varsayılan olarak iş ilanıyla ilgili olanları tercih et, "
        "ancak kullanıcının düzenleme notu varsa ona öncelik ver.\n\n"
        ...
        "- Kullanıcı notu bir öğeyi tut / çıkar / kısalt / yeniden yaz derse bunu uygula; "
        "ilanla alakasız olsa bile istenen öğeyi DAHİL edip açıklamasını kısa yaz.\n"
    ...
    "cv_shorten_content": (
        ...
        "aşacak şekilde uzattı. Anlam kaybı olmadan her açıklamayı kısalt. "
        "İlanla alakalı kısımları öncelikle koru; kullanıcı notu varsa ona da uy "
        "(belirli bir öğeyi daha da kısalt / vurgula / dokunma demiş olabilir).\n\n"
        "İlan pozisyonu: {position_title}\n"
        "Zorunlu beceriler: {required_skills}\n"
        "Tercih edilen beceriler: {nice_to_have_skills}\n\n"
        "{extra_prompt_section}"
