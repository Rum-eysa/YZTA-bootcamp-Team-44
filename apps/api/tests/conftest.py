...
# Testler ASLA dev veritabanına karşı çalışmamalı (drop_all dev verisini siler).
# TEST_DATABASE_URL verilmediyse, dev DB adına otomatik "_test" eki eklenir.
...
async def prepare_database():
    ...
    # Uygulamanın gerçek DB'ye (app.database.AsyncSessionLocal) değil, test DB'sine
    # yazmasını garanti eder - aksi halde testler dev veritabanını kirletir/siler.
